...
void SetFreeRunning(TMC5130 &stepper, uint8_t SpeedFor1RPS, uint8_t mres, bool Positive){ //
  ...
  stepper.setMaxVelocity( (uint32_t)(53687*SpeedFor1RPS)>>(mres));
  stepper.setRampMode(Positive?TMC5130::VelocityPositiveMode:TMC5130::VelocityNegativeMode);
}
