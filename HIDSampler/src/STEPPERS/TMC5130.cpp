...
TMC5130::TMC5130(SPIClass &spiRef, uint8_t csPin, uint8_t cePin, SPI_ENABLER_CB cbCS, uint32_t spiHz, char* Name, int32_t Max_Steps)
    : cbEnableChipSelect(cbCS), csPinAddress(csPin), cePinAddress(cePin), StepperName(Name), MaxSteps(Max_Steps) {
